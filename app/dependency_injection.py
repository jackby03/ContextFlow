# This file is optional. FastAPI's `Depends` often handles most DI needs effectively.
# You might use this if you need a more complex container, especially for wiring
# dependencies within the application or infrastructure layers outside of FastAPI request scope,
# or if you prefer a dedicated container pattern (e.g., using python-dependency-injector).

# Example using manual wiring or a simple registry (Illustrative purposes)

from sqlalchemy.ext.asyncio import AsyncSession

from contexts.users.application.command_handlers import \
    CreateUserCommandHandler
from contexts.users.application.query_handlers import (GetUserByIdQueryHandler,
